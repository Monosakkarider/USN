/*
PB1:
Using the SSITEM and SSSALES tables, retrieve the total sales units for each item brand. 
Rank the item brands based on the total sales units in descending order. 
